...
public class PathMap
{
	...
	public List<Coordinate> getOrigin()
	{
		return originCells;
	}
	...
	public List<Coordinate> getWayPoint()
	{
	...
	public void upCoordinate(Coordinate c)
	{
		try 
		{
			 c.getSurroundings().put(1, cells[c.getRow()][c.getColumn()+1]);
		}
		catch(Exception e)
		{
			e.getMessage();
	...
	public void rightCoordinate(Coordinate c) 
	{
		try 
		{
			 c.getSurroundings().put(2, cells[c.getRow()+1][c.getColumn()]);
		}
		catch(Exception e)
		{
			e.getMessage();
	...
	public void downCoordinate(Coordinate c) 
	{
		try 
		{
			 c.getSurroundings().put(3, cells[c.getRow()][c.getColumn()-1]);
		}
		catch(Exception e)
		{
			e.getMessage();
	...
	public void leftCoordinate(Coordinate c) 
	{
		try 
		{
			 c.getSurroundings().put(4, cells[c.getRow()-1][c.getColumn()]);
		}
		catch(Exception e)
		{
			e.getMessage();
